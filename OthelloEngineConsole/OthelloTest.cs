...
namespace Othello
{
    ...
    public class OthelloTest
    {
        ...
        public static void CheckAIRandomBestMove()
        {
            ...
            var oPlayerB = new OthelloPlayer(OthelloPlayerKind.Black, "PlayerB");
            var oGame = new OthelloGame(oPlayerA, oPlayerB, oPlayerA);
            var oAIPlayer = new OthelloAI(oGame, oPlayerB, oPlayerA);
            ...
            List<Tuple<OthelloToken, float>> CalculatedMoves = oAIPlayer.GetMoves(oAIPlayer);
            var oTarget = oAIPlayer.GetBestRandomMove(CalculatedMoves);
